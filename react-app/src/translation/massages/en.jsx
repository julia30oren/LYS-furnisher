...
export default {
    [LOCALES.ENGLISH]: {
        ...
        "home-9-text": "We take into account the convenient and functional arrangement of furniture in the room, taking into account the design.",
        ...
        "home-13-text": "That is why all our furniture is exclusive. Are made only in one copy.",
        "home-14-text": "TURNKEY FURNITURE",
        "home-15-text": "We perform and control all stages of production: from sketching to installation work. We save your time and meet deadlines.",
        ...
        "coating-3-row-4": "Varnish acrylic 2-component. Used for further color fastness during operation. Painting with enamels provides a stable opaque film, which gives a completely solid color. The coating consists of 6 layers (primer, enamel and varnish).",
