...
export default {
    [LOCALES.ENGLISH]: {
        ...
        "home-9-text": "We take into account the convenient and functional arrangement of furniture in the room.",
        ...
        "home-13-1-text": "All furniture is handmade. That is why each product is unique.",
        ...
        "home-15-2-text": "We save your time and meet deadlines.",
        ...
        "about-3-text": "And today we can say for sure that nothing is impossible! Thus was born the family furniture workshop «LYS».",
        "about-4-text": "When the idea first arose, we were united by a common desire to make special things ourselves, which would give joy to its owner. Yes, having no resources: no tools, no savings, no connections, we stubbornly went to our goal!",
        ...
        "coating-6-row-6": "To give the furniture the spirit of antiquity, painting is done by applying patina on a ready-made object. The protruding elements are ground to a tree that allows to reach effect of long-term operation. To fix the layers, the product is fixed with several layers of varnish.",
